    ...
    if st.sidebar.button("Process", type='primary', key = 'process'):        
        ...
        if st.session_state.despike_act:
            if st.session_state.despike_function == "Auto despike method":
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Despike_Auto_Used")
            elif st.session_state.despike_function == "Manual despike method":
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Despike_Manual_Used")
        ...
        if st.session_state.smoothening_act:
            if st.session_state.smoothening_function == "Savitzky-Golay filter":
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Smoothening_Savgol_Filter_Used")
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Smoothening_FFT_Filter_Used")
        ...
        if st.session_state.baselineremoval_act:
            if st.session_state.baselineremoval_function == "airPLS":
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Baseline_AirPLS_Used")
            if st.session_state.baselineremoval_function == "ModPoly":
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Baseline_Mod_Poly_Used")
            ...
            try:
                if st.session_state.baselineremoval_function == "Gaussian-Lorentzian Fitting":
                    ...
                    function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Baseline_Gaussian_Lorentzian_Fitting_Called")
        ...
        if st.session_state.normalization_act:
            if st.session_state.normalization_function == "Normalize by area":
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Normalization_Area_Used")
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Normalization_Peak_Used")
                ...
                function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Normalization_Minmax_Used")
        ...
        if st.session_state.outlierremoval_act:
            ...
            function.log_function_use_count(st.session_state.function_log_file_path, "Processing_Remove_Outliers_Used")
