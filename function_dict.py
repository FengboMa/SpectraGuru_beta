...
references = {
    ...
    46:{"text":"https://fengboma.github.io/docs.spectraguru/docs/Analytics_Page/Analytics_Features/Spectrum_Calculation/", "link":True, "doc_page":True, "notes":"Spectrum Calculation doc page (created in the spectrum-calculation documentation phase)"},
...
reference_map = {
    ...
    'Analytics_FFT':[43,45],
    'Analytics_Spectrum_Calculation':[46,22],
