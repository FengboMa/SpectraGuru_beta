...
names = {
    ...
    'Analytics_Silicon_Calibration':("Silicon calibration", "Silicon calibration"),
...
references = {
    ...
    47:{"text":"", "link":None, "doc_page":None, "notes":"Silicon calibration: reserved for the silicon 520.7 cm-1 reference-standard citation. Slot 46 is left free for the spectrum-calculation branch."},
...
reference_map = {
    ...
    'Analytics_FFT':[43,45],
    'Analytics_Silicon_Calibration':[47],
